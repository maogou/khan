...
import (
	"maogou/khan/internal/command/auth"
	"maogou/khan/internal/command/demo"
	"maogou/khan/internal/command/license"
	"maogou/khan/internal/command/login"
	"maogou/khan/internal/command/serve"
	"maogou/khan/internal/command/upgrade"
	"maogou/khan/internal/command/version"
